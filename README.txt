...
Problema 2 -> SolidCalculations.java
Para ejecutar solución, dentro del directorio src
javac SolidCalculations.java
java SolidCalculations

Problema 3 -> FractionOperations.java
Para ejecutar solución, dentro del directorio src
javac FractionOperations.java
java FractionOperations